...
function Content(){
  ...
  const handleMostrarNotaPonderada = () => {
    ...
    setTextoBotao(mostrarNotaPonderada ? 'Ver Nota Ponderada' : 'Ver Nota Absoluta');
  };
                ...
                <table class="table table-bordered" id="table-boletim" data-cfgacad="">
                  <thead>
                    <tr>
                      ...
                      <button className="btn btn-small btn-nota-ponderada-absoluta" onClick={handleMostrarNotaPonderada}>
                    ...
                    <th colspan="2" class="borderless formula-media-final"></th>
                    <th colspan="2" class="table-title borderless">
                        <span>COM PAI</span>
                    </th>
                    <th colspan="1" class="table-title borderless">
                    ...
                    <th colspan="5" class="table-title borderless">
                    </th>
                    </tr>
                    <tr>
                    <th colspan="2" class="borderless calculo-media-final"></th>
                    <th colspan="2" class="table-title borderless">
                        <span>SEM PAI</span>            	
                    </th>
                    <th colspan="1" class="table-title borderless">
                    ...
                    <th colspan="4" class="table-title borderless">Final</th>
                    </tr>
                  </thead>
                  <tbody>
                      <tr>
                          ...
                          <th class="table-subtitle"><span>PR</span></th>
                          <th class="table-subtitle"><span>SUB</span></th>
                          <th class="table-subtitle">
                              <span>PAI</span>
                              <a href="/" id="btn-pai123">
                                  <img class="comp-nota" alt="Clique aqui e veja a composição das notas do PAI" title="Clique aqui e veja a composição das notas do PAI" src="/plus.png"></img>
                              </a>
                          </th>
                          <th class="table-subtitle"><span>BO</span></th>
                      ...
                      <tr>
                          ...
                          <td class="nota-mac">
                              ...
                              <div class="td-nota-ponderada" title=" x 0.5 = "></div>
                          </td>
                          <td class="nota-prova ">
                              <div class="td-nota-absoluta"></div>
                              <div class="td-nota-ponderada" title=" x 0.5 = "></div>
                          ...
                          <td class="nota-pai cls-td-pai">
                              <div class="td-nota-absoluta"></div>
                              <div class="td-nota-ponderada" title=" x 0 = "></div>
                          </td>
                          <td class="nota-bo"></td>
                          <td>0</td>
                          <td class="nota-mf"></td>
                      ...
                      <tr>
                          ...
                          <td>Regular</td>
                          <td>80</td>
                          <div className="td-nota-absoluta" data-coeficiente-ponderacao="0.3">
                            {mostrarNotaPonderada ? calcularNotaPonderada(4.00, 0.3) : 4.00}
                          </div>
                          <td class="nota-prova ">
                              <div class="td-nota-absoluta"></div>
                              <div class="td-nota-ponderada" title=" x 0.4 = "></div>
                          </td>
                          <td class="nota-sub ">
                              <div class="td-nota-absoluta"></div>
                              <div class="td-nota-ponderada" title=" x 0.4 = "></div>
                          ...
                          <td class="nota-pai cls-td-pai">
                              <div class="td-nota-absoluta"></div>
                              <div class="td-nota-ponderada" title=" x 0.3 = "></div>
                          </td>
                          <td class="nota-bo"></td>
                          <td>
                          <a alt="Clique aqui para ver as datas das suas faltas" href="/" class="link-ver-faltas"><u>4</u></a>            </td>
                          <td class="nota-mf"></td>
                          <td>Indefinido</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                          <td class="table-left">Sistemas Integrados de Gestão</td>
                          <td>SI 3A NOITE</td>
                          <td>Regular</td>
                          <td>80</td>
                          <div className="td-nota-absoluta" data-coeficiente-ponderacao="0.3">
                            {mostrarNotaPonderada ? calcularNotaPonderada(4.50, 0.3) : 4.50}
                          </div>
                          <td class="nota-prova ">
                              <div class="td-nota-absoluta"></div>
                              <div class="td-nota-ponderada" title=" x 0.4 = "></div>
                      ...
                      <tr>
                          <td class="table-left">Trabalho de Conclusão de Curso - TCC II</td>
                          <td>SI 3A NOITE</td>
                          <td>Regular</td>
                          <td>80</td>
                          <div className="td-nota-absoluta" data-coeficiente-ponderacao="0.3">
                            {mostrarNotaPonderada ? calcularNotaPonderada(3.00, 0.5) : 3.00}
                          </div>
                          <td class="nota-prova ">
                              <div class="td-nota-absoluta"></div>
                              <div class="td-nota-ponderada" title=" x 0.5 = "></div>
                          ...
                          <td class="nota-bo"></td>
                          <td>
                          <a alt="Clique aqui para ver as datas das suas faltas" href="/" class="link-ver-faltas"><u>8</u></a>            </td>
                          <td class="nota-mf"></td>
                          <td>Indefinido</td>
                      </tr>
                      ...
                      <tr>
                          ...
                          <th colspan="5" class="table-left">
                              ...
                              <button class="btn" id="btn_print"><span id="imprimir" >Imprimir</span><img src="/imprimir.png" alt=""></img></button>	
                              </div>
                          </th>
                      </tr>
                  </tbody>
